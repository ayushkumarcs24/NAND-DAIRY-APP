...
const s = StyleSheet.create({
  ...
  samitiName:    { color: C.textPri, fontSize: 15, fontWeight: '600', letterSpacing: -0.2 },
  ...
  inputField:    { backgroundColor: C.inputFill, borderRadius: 10, color: C.textPri, fontSize: 15, paddingHorizontal: 14, height: 46, marginBottom: 20 },
