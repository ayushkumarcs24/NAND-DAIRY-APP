...
const s = StyleSheet.create({
  ...
  card:          { backgroundColor: C.surface, borderRadius: 16, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 14 },
  cardDisabled:  { opacity: 0.6 },
  iconBox:       { width: 48, height: 48, borderRadius: 12, backgroundColor: C.surfaceVar, justifyContent: 'center', alignItems: 'center' },
  productName:   { color: '#fff', fontSize: 16, fontWeight: '600', letterSpacing: -0.2, marginBottom: 4 },
  ...
  input:         { backgroundColor: C.surfaceVar, borderRadius: 12, color: '#fff', fontSize: 15, paddingHorizontal: 16, height: 50, marginBottom: 16 },
