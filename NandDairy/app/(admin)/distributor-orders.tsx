...
const s = StyleSheet.create({
  ...
  card:           { backgroundColor: C.white, borderRadius: 16, padding: 16, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 },
  cardTop:        { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 },
  orderId:        { color: C.textSec, fontSize: 13, marginBottom: 2 },
  distName:       { color: C.textPri, fontSize: 16, fontWeight: '600', letterSpacing: -0.2 },
  statusChip:     { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  statusText:     { fontSize: 12, fontWeight: '600' },
  cardMid:        { flexDirection: 'row', backgroundColor: C.inputFill, borderRadius: 12, padding: 12, marginBottom: 12 },
  midBlock:       { flex: 1 },
  midLabel:       { color: C.textSec, fontSize: 11, textTransform: 'uppercase', marginBottom: 4 },
  midValue:       { color: C.textPri, fontSize: 15, fontWeight: '700' },
  cardAction:     { borderTopWidth: 1, borderTopColor: C.border, paddingTop: 12 },
  ...
  itemRow:        { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.border },
  itemName:       { color: C.textPri, fontSize: 14, fontWeight: '600' },
  itemSub:        { color: C.textSec, fontSize: 12, marginTop: 4 },
  itemTotal:      { color: C.primary, fontSize: 14, fontWeight: '700' },
  summaryBox:     { backgroundColor: C.inputFill, borderRadius: 16, padding: 16, marginBottom: 16 },
  totalRow:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  totalLabel:     { color: C.textSec, fontSize: 15 },
  totalValue:     { color: C.textPri, fontSize: 20, fontWeight: '700', letterSpacing: -0.3 },
  notesText:      { color: C.primary, fontSize: 12, marginTop: 12 },
