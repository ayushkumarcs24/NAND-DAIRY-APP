...
const s = StyleSheet.create({
  ...
  listTitle:      { color: C.textPri, fontSize: 22, fontWeight: '600', letterSpacing: -0.3 },
  ...
  card:           { backgroundColor: C.white, borderRadius: 16, padding: 16, marginBottom: 12, flexDirection: 'row', alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, elevation: 2 },
  orderId:        { color: C.textPri, fontSize: 14, fontWeight: '700' },
  ...
  orderAmount:    { color: C.textPri, fontSize: 17, fontWeight: '700', letterSpacing: -0.2 },
  ...
  summaryBox:     { backgroundColor: C.inputFill, borderRadius: 16, padding: 16 },
